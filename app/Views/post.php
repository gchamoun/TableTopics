  ...
  <body style="padding-top: 72px;">
    ...
    <section class="py-5 py-lg-7">
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            <p class="subtitle text-primary">Add a new prompt</p>
            ...
            <p class="mb-5 mb-lg-0"> <a class="btn btn-primary" href="user-add-1.html">Add your Prompt</a></p>
          </div>
          <div class="col-lg-5 ms-auto d-flex align-items-center"><img class="img-fluid" src="img/illustration/undraw_celebration_0jvk.svg" alt="" style="width: 400px;"></div>
        </div>
      </div>
    </section>
    <!-- Footer-->
